<template>
  <form class="flex w-1/3 gap-3 px-4 py-3 font-medium marker:content-none">
    <div class="flex justify-between w-full text-xl ms-8">
      <input v-model="list.name" type="text" id="listName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 mb-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="List Name" required/>
    </div>
