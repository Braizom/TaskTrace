<template>
  <form class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm mb-2 dark:bg-gray-800 dark:border-gray-600">
    <div class="w-full flex items-center">
      ...
      <div class="w-full ms-10">
        <div class="w-full flex flex-wrap justify-between items-center mb-2">
          <div>
            <input v-model="element.name" type="text" id="listName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required placeholder="Element Name"/>
          </div>
